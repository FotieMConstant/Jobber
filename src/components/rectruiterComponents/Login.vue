<template>
  <span>
    <v-card
      id="wrapper"
      class="pa-12 mx-auto pb-16"
      elevation="12"
      height="440"
      max-width="500"
    >
      <v-card-title class="title font-weight-regular justify-space-between">
        <span class="ml-n4">Recruiter Sign-In</span>
        <v-avatar
      ...
      <v-form @submit.prevent="signIn" v-model="valid" :lazy-validation="lazy">
        ...
        <div class="text-center">
          <v-btn type="submit" class="mx-auto mt-n4" color="warning"
            >Login</v-btn
          >
          <br />
...
export default {
  ...
  methods: {
    // recruiter's sign in
    async signIn() {
      let result = await database.signInRecruiter(this.email, this.password);
